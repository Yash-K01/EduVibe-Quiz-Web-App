...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 Sending student login data:', {
      ...
      if (response.data.success) {
        ...
        showSuccessPopup('Student Login Successful!', navigate);
      } else {
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        if (error.response.status === 401) {
          setApiError('Invalid Student ID or password');
        } else {
            ...
            <div className="p-8">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className={`block w-full pl-10 pr-3 py-2.5 bg-zinc-50 dark:bg-zinc-800 border ${
                        errors.studentId ? 'border-red-500' : 'border-primary/30'
              ...
              <div className="mt-6 pt-4 border-t border-zinc-100 dark:border-zinc-800 text-center">
                <p className="text-xs text-zinc-500">
                  New student? Contact your school administrator for credentials
                </p>
              </div>
            </div>
          </div>
